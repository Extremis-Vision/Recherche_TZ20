...
def get_response_from_raginfo(query: str, collection, limitContext : int = 5, model_name: str = "ministral-8b-instruct-2410"):
...
def get_RAG_response(contenu : str, question : str , limitContext : int = 10, model : str =  "ministral-8b-instruct-2410"):
    try:
        ...
        response = get_response_from_raginfo(question, collection, limitContext, model)
